...
SWEP.PrintName = "Сырое мясо"
SWEP.Instructions = "Сырое мясо. Если съесть, почти не даст сытости. Лучше приготовить на плите."
SWEP.Category = "ZCity Cooking"
SWEP.Spawnable = true

SWEP.WorldModel = "models/foodnhouseholditems/steak1.mdl"
SWEP.FoodModels = {
	"models/foodnhouseholditems/steak1.mdl"
}
SWEP.DoNotDropModels = {
	["models/foodnhouseholditems/steak1.mdl"] = true
}
...
if SERVER then
	function SWEP:Heal(ent, mode)
		...
		org.satiety = math.min(org.satiety + 2, 100)
